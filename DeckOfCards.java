...
{ 
    ...
    {
        // select a random number between 0 and 51 int second = (int)(Math.random() * 52);
        int second = (int)(Math.random() *52);
        // swap current Card with randomly selected Card Card temp = deck[ first ];
...
{ // determine whether Cards remain to be dealt if (currentCard < deck.length)
